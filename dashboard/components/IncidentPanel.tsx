    ...
    <>
      <div className="flex items-center gap-3 px-3 py-2 rounded-lg border border-ripple-hit/20 bg-ripple-hit/5">
        <div className="flex items-center gap-1.5 shrink-0">
          <span
            className="w-1.5 h-1.5 rounded-full bg-ripple-hit animate-pulse"
            aria-hidden="true"
          />
          <span className="font-mono text-[10px] font-bold text-ripple-hit tracking-wider">
            {incident.id}
          </span>
        </div>
        ...
        <div className="flex items-center gap-3 shrink-0 ml-auto">
          <span className="font-mono text-[10px] text-ripple-subtle">
            <span className="text-ripple-scan font-semibold">
              {incident.duration}m
            </span>{" "}
            outage
          </span>
          <span className="font-mono text-[10px] text-ripple-subtle">
            <span className="text-ripple-hit font-semibold">
              {incident.cost}
            </span>{" "}
            est. cost
          </span>
          ...
          {dtEvidence && (
            ...
            >
              <span className="flex items-center gap-1.5">
                <span
                  className="w-1.5 h-1.5 rounded-full bg-white/80 animate-ping absolute left-2 top-1/2 -translate-y-1/2"
                  aria-hidden="true"
                />
